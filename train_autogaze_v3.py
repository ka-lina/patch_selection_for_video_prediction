    ...
    for epoch in range(start_epoch, total_epochs):
        ...
        for batch in pbar:
            ...
            with torch.amp.autocast('cuda'):
                ...
                # Combined loss
                loss = quality_reduction_allowance*pred_loss + lambda_sparsity * sparsity_term
        ...
        with torch.no_grad():
            for batch in val_loader:
                ...
                with torch.amp.autocast('cuda'):
                    ...
                    loss = quality_reduction_allowance*pred_loss + lambda_sparsity * sparsity_term #+ 0.01 * threshold_penalty
