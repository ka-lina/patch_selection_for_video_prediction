...
quality_reduction_allowance = 0.9
lambda_sparsity = 1  # Adjust this weight
beta = 10
baseline_loss = 0.038635
    ...
    for epoch in range(start_epoch, total_epochs):
        ...
        for batch in pbar:
            ...
            with torch.amp.autocast('cuda'):
                ...
                quality_ratio = pred_loss / baseline_loss
                quality_penalty = torch.relu(quality_ratio - 1.10)  # Only penalize if >10% worse
                ...
                sparsity_term = (avg_patches / total_patches)

                # Combined loss
                loss = beta * quality_penalty + lambda_sparsity * sparsity_term
